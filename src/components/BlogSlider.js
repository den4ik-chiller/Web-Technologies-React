...
import {Image} from "react-bootstrap"; // Import Bootstrap CSS
...
export default function BlogSlider() {
    ...
    return (
        <div className="container mt-4">
            <div className="row">
                <div className="col-md-12 text-center">
                    {Object.keys(trendData).map((trend) => (
                        <button
                            key={trend}
                            className="btn btn-primary mr-2 mb-2 mx-2"
                            onClick={() => handleScrollToPost(trend, 0)}
                        >
                            {trend}
                        </button>
                    ))}
            ...
            <div className="row">
                {Object.keys(trendData).map((trend) => (
                    <div key={trend} className="col-md-4">
                        <div className="mb-3">
